...
<body>
    ...
    <table cellpadding="5" style="border:none;"  >
        ...
        <?php //  if(file_exists('assets/img/haofe/logo.png')){ ?>
            <?php // echo \Asset::img('haofe/logo.png', array('id' => 'logo', 'alt'=>"img", 'style'=>'margin: -80px 0px; height: 180px; width: 656px;')); ?>
        <?php // } ?>
...
<!--        <table style="width:100%;border:none" >
    ...
    <?php if($order->document_type != 8 && $order->document_type != 3) {  ?>
        ...
        <table id="items" cellpadding="4"  class="items-orderlines" style="display:inline-table; margin: 18px 0px 30px 0;font-size: 13px; text-align: right;border:none">
