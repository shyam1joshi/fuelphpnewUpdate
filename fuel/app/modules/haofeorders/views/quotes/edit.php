...
<label style="    margin-right: 10% !important;">יצירת הזמנה</label>
<br/>
<form method='post' action="<?php // echo $base;/create ?>" id="myFormId"  enctype='multipart/form-data' role="form" class="span12 col-lg-10  " >
  <input type="hidden" name="customer_id" id="customerId" value="<?php   echo $order->customer_id; ?>" />
...
<!--                <span class="headerChangePlus">+</span>
          ...
          <div id="lab" class="span12 box-body" style="    padding-top: 30px;" data-inset="true" data-theme="e" data-content-theme="d" >
            ...
            <input type="hidden" name="amount_totalbeforetax" id="amount_totalbeforetax" value="<?php echo $order->amount_totalbeforetax ?>" />
            <input type="hidden" name="amount_total"  id="amount_total" value="<?php echo $order->amount_total ?>" />
            <input type="hidden" name="id"  id="orderId" value="<?php echo $order->id ?>" />
...
<div class="span10 sortgroup" style="    margin-right: 10% !important;">
    <div class="">
...
<!--                <span class="headerChangePlus">+</span>
                <span class="headerChangeMinus">&nbsp;&nbsp;-&nbsp;&nbsp;</span>-->
                <span class="title"><?php echo $code->name; ?></span><span class="headerChange"></span></h4>
...
<button id="finish" <?php  if(isset($order) && count($order->quotelines) <1 ){ 
    
    
?> disabled="disabled"<?php } ?> class="btn btn-primary">הצג סיכום</button>
