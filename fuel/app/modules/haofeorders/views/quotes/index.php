...
<label for="name" ><?php echo \Lang::get('label.quotes.name')?\Lang::get('label.quotes.name'):'label.quotes.name'; ?></label>    
...
<!--<a class="btn" href="/quotes/generateProductsReport"><?php echo \Lang::get('message.viewundeliveredproducts')?\Lang::get('message.viewundeliveredproducts'):'View Undelivered Products'; ?></a>-->
<?php   if(  $warehouse == 0){ ?>
<p>
...
<table class="table table-striped">
	<thead>
		<tr>
                    ...
                    ?>
<!--                    <th><?php  
//                    echo \Lang::get('label.quotes.comment')?\Lang::get('label.quotes.comment'):'Comment';
...
//                    
				...
				<?php echo Html::anchor("$base/view/".$car->id, '<i class="icon-eye-open" title="View"></i>', array('class'=>'btn btn-primary', 'style' => 'display: inline-block !important;')); ?> &nbsp;&nbsp;
...
//                                    if(empty($car->delivery_id)){ ?>
                                    <?php // echo Html::anchor("$base/edit/".$car->id, '<i class="icon-wrench" title="Edit"></i>', array('class'=>'btn btn-danger', 'style' => 'display: inline-block !important;')); ?> 
                                    <?php // echo Html::anchor("$base/convertToDelivery/".$car->id, 'הפוך לתעודת משלוח', array('class'=>'btn btn-danger', 'style' => 'display: inline-block !important;')); ?> 
				
                            <?php // } ?>
                            <?php // } ?>
                            <?php } ?>
                            <?php if(isset($enablesyncbackquote) && $enablesyncbackquote==1 && isset($car->suppliedstatus) && $car->suppliedstatus != 1 ){ ?>
