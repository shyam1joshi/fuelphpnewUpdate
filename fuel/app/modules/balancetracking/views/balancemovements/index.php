...
//                                if(property_exists($related,"name"))
			...
			<td><?php echo $car->$column; ?></td>
                    <?php } ?>
			<td style="display: none;" class="deleteWithReset"><?php echo Html::anchor("/balancetracking/$base/deleteWithReset/".$car->id, '<i class="icon-trash" title="Delete"></i>', array('onclick' => "return confirm('Are you sure?')", 'style'=>'display:inline;')); ?>
