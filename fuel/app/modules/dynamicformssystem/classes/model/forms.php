    ...
    protected static $_properties = array(
		...
		'title'=> array(
                ...
                'csvproperties'=>array( 
                    ...
                    'fieldstobesaved'=>array( 
                        'null'=>true,
                        'data_type' => 'varchar',
                        'label' => 'label.images.fieldstobesaved',
                        'type'=> 'longtext',   
                        'form' => array('type' => 'text'), 
                        ),
                        'fieldstobereset'=>array( 
                            'null'=>true,
                            'data_type' => 'varchar',
                            'label' => 'label.images.fieldstobereset',
                            'type'=> 'longtext',   
                            'form' => array('type' => 'text'), 
                            ),
                            'numberOfDaysAfterMarkedDeleted' => array(
                                            'type'=> 'int',    
                                            'label' => 'label.images.deleted',                                     
                                            'null'=> true,
                                            'form'=> array( 'type' => false)
                                    ),
                            'enablePermanantDelete' => array(
                                            'type'=> 'int',    
                                            'label' => 'label.images.deleted',                                     
                                            'null'=> true,
                                            'form'=> array( 'type' => false)
                                    ),
                            'lastDeleteDate' => array( // set date once data is deleted permanantly for the day
                                'type'=> 'varchar',  
                                'constraint' => '100',  
                                'label' => 'label.images.deleted',                                     
                                'null'=> true,
                                ...
                                'lastDeleteDateTime' => array( // set date once data is deleted permanantly for the day
                                    'type'=> 'varchar',    
                                    'constraint' => '100',
                                    'label' => 'label.images.deleted',                                     
                                    'null'=> true,
                     ...
                     'callback_url' => array(
                        'type'=> 'varchar',    
                        'constraint'=> '120',    
                        'label' => 'label.images.callback_url',                                     
                        'null'=> true,
                        'form'=> array( 'type' => false)
                ),  
                'fields_to_be_sent' => array(
                   'type'=> 'longtext',     
                   'label' => 'label.images.fields_to_be_sent',                                     
                   'null'=> true,
                   'form'=> array( 'type' => false)
           ), 
                'deleted' => array(
