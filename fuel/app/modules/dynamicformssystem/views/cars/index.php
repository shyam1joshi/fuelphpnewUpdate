...
<?php foreach ($cars as $car): ?>		<tr>
                    ...
                    foreach($listview as $column => $properties) {
                       ...
                       if(key_exists('relation', $properties)){
                            ...
                            if(is_object($car->$rel_mod)){
                                ...
                                if( isset($related->representative_name))
                                    $car->$column = $related->representative_name;
                                else 
                                if( isset($related->country_name))
                                    $car->$column = $related->country_name;
                                else { 
			...
			<td><?php
                            ...
                            if($column == 'representative_id') 
                                $car->customer->representative_name;
                            else{
                                
                                if($column == 'country_id')
                                
                                 $car->country->country_name;
                            else
                            echo 
                                $car->$column;
