...
?>
<p>
	<?php echo Html::anchor("#",\Lang::get('message.create')?\Lang::get('message.create'):'הוסף', array('class' => 'btn btn-success',   'id'=>"openNewCallx", "style"=>"display:inline!important" )); ?>
...
<a href="
<?php 
$actual_link = "https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]/triggercreate";
echo "$actual_link"; 
?>"
><?php echo "$actual_link"; ?></a>

<?php  include_once(APPPATH.'/modules/dynamicforms/modules/'.$folder.'/views/'.$filepath.'/createform.php'); ?>
<?php //  include_once('../../../modules/scdsfs/view/scdsfs/createform.php'); ?>
