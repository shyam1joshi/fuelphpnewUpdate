...
'id'=>array(
  ...
  'agent_code'=>array(
    ...
    'allowonlyagentdata' => array(        
                	'label'=>'label.agents.allowonlyagentdata',
			'data_type'=>'int',
                                    'null'=> true,
                                    'type'  =>  'int',
                        'default' => 0,
    ...
    'receiveAllEmail' => array(        
                	'label'=>'label.agents.receiveAllEmail',
			'data_type'=>'int',
                                    'null'=> true,
                                    'type'  =>  'int',
                        'default' => 0,
    ...
    'disableindex' => array(        
                	'label'=>'label.agents.disableindex',
			'data_type'=>'int',
                                    'null'=> true,
                                    'type'  =>  'int',
                        'default' => 0,
 ...
 'formsallowed'=>array(
                	'label'=>'label.agents.formsallowed',
			'data_type'=>'int',
                                    'null'=> true,
                                    'type'  =>  'text',
    'form' => array('type' => 'text'),
...
protected static $_has_one = array(
 ...
 function save($cascade = null, $use_transaction = false){
    ...
    public static function addDefaultData(){
        ...
        $users = array('saed','shyam@shyamjoshi.in','shyamjoshi','namrata', 'raedk', 'louaih', 'louai', 'raed' ); //yaser closed
